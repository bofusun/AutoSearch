...
def compute_score_em(solution_str, ground_truth, new_parts, method='strict', format_score=0., score=0.8):
    ...
    for i in even_indices:
        if step_scores[i] == 1:
            step_scores[i] = 0.2 / count_ones if count_ones > 0 else 0
        else:
            step_scores[i] = -0.2 / count_zeros if count_zeros > 0 else 0
