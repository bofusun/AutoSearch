...
class ActorRolloutRefWorker(Worker):
    ...
    def __init__(self, config: DictConfig, role: str):
        ...
        self.role = role
        assert self.role in ['actor', 'rollout', 'ref', 'actor_rollout', 'actor_rollout_ref', 'external_rollout']

        self._is_actor = self.role in ['actor', 'actor_rollout', 'actor_rollout_ref', 'external_rollout']
        self._is_rollout = self.role in ['rollout', 'actor_rollout', 'actor_rollout_ref', 'external_rollout']
