...
class RayPPOTrainer(object):
    ...
    #     reward_tensor_lst = []
    #     data_source_lst = []
    #     valid_search_counts = []  # ✅ 新增统计 valid_search
    ...
    #             # only validate on rule-based RM
    ...
    #         metric_dict = {}
    #         for data_source, rewards in zip(data_sources, reward_tensor):
    #             metric_dict.setdefault(f'val/test_score/{data_source}', []).append(rewards.item())
    ...
    #                 # ✅ 统计 valid_search_stats
    #                 if 'valid_search_stats' in test_batch.meta_info:
    #                     valid_search_counts.extend(test_batch.meta_info['valid_search_stats'])
    ...
    #         # ✅ 平均 valid_search_stats
    #         if valid_search_counts:
    #             avg_valid_search = float(np.mean(valid_search_counts))
    #             metric_dict["env/number_of_valid_search"] = avg_valid_search
    #             print(f"[Validation] env/number_of_valid_search: {avg_valid_search:.2f}")
    #         else:
    #             print("[Validation] No valid_search_stats found in validation results")
    ...
    #     data_source_lst = []
    #     valid_search_counts = []    # ✅ 新增统计 valid_search
    #     invalid_search_counts = []  # ✅ 新增统计 invalid_search
    ...
    #                 # ✅ 统计 valid_search_stats 和 invalid_search_stats
    #                 if 'valid_search_stats' in test_batch.meta_info:
    #                     valid_search_counts.extend(test_batch.meta_info['valid_search_stats'])
    #                 if 'invalid_search_stats' in test_batch.meta_info:
    #                     invalid_search_counts.extend(test_batch.meta_info['invalid_search_stats'])
    ...
    #         # ✅ 平均 valid_search_stats & invalid_search_stats
    #         if valid_search_counts:
    #             avg_valid_search = float(np.mean(valid_search_counts))
    #             metric_dict["env/number_of_valid_search"] = avg_valid_search
    #             print(f"[Validation] env/number_of_valid_search: {avg_valid_search:.2f}")
    ...
    #         if invalid_search_counts:
    #             avg_invalid_search = float(np.mean(invalid_search_counts))
    #             metric_dict["env/number_of_invalid_search"] = avg_invalid_search
    #             print(f"[Validation] env/number_of_invalid_search: {avg_invalid_search:.2f}")
    #         else:
    #             print("[Validation] No invalid_search_stats found in validation results")
